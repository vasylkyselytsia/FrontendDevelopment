 ...
 */
    ...
    value('$routerRootComponent', new Object()).factory('$rootRouter', ['$q', '$location', '$$directiveIntrospector', '$browser', '$rootScope', '$injector', '$routerRootComponent', routerFactory]);
...
// Convert an object of url parameters into a string that can be used in an URL
        ...
        var Url = (function () {
            ...
            Url.prototype._auxToString = function () {
                return this.auxiliary.length > 0 ?
                    ('(' + this.auxiliary.map(function (sibling) {
        ...
        var AbstractRoute = (function () {
            function AbstractRoute(_a) {
                var name = _a.name, useAsDefault = _a.useAsDefault, path = _a.path, regex = _a.regex,
                    serializer = _a.serializer, data = _a.data;
                this.name = name;
        ...
        var Route = (function (_super) {
            ...
            function Route(_a) {
                var name = _a.name, useAsDefault = _a.useAsDefault, path = _a.path, regex = _a.regex,
                    serializer = _a.serializer, data = _a.data, component = _a.component;
                _super.call(this, {
                    name: name,
 ...
 * 'MyLoadedCmp'})
        ...
        var AsyncRoute = (function (_super) {
            ...
            function AsyncRoute(_a) {
                var name = _a.name, useAsDefault = _a.useAsDefault, path = _a.path, regex = _a.regex,
                    serializer = _a.serializer, data = _a.data, loader = _a.loader;
                _super.call(this, {
                    name: name,
                    useAsDefault: useAsDefault,
                    path: path,
        ...
        var Redirect = (function (_super) {
            ...
            function Redirect(_a) {
                var name = _a.name, useAsDefault = _a.useAsDefault, path = _a.path, regex = _a.regex,
                    serializer = _a.serializer, data = _a.data, redirectTo = _a.redirectTo;
                _super.call(this, {
                    name: name,
                    useAsDefault: useAsDefault,
                    path: path,
            ...
            Router.prototype.commit = function (instruction, _skipLocationChange) {
                ...
                if (isPresent(this._outlet) && isPresent(instruction.component)) {
                    ...
                    if (componentInstruction.reuse) {
                        ...
                        next =
                            this.deactivate(instruction).then(function (_) {
